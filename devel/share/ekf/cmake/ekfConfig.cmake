...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/chenlee/robot_navigation/src/navigation_experiment/multisensor_information_fusion)
  set(ekf_DEVEL_PREFIX /home/chenlee/robot_navigation/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/chenlee/robot_navigation/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'chenlee <chenlee@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chenlee/robot_navigation/src/navigation_experiment/multisensor_information_fusion/${idir}'.  Ask the maintainer 'chenlee <chenlee@todo.todo>' to fix it.")
    endif()
...
set(ekf_EXPORTED_TARGETS "ekf_generate_messages_cpp;ekf_generate_messages_lisp;ekf_generate_messages_py")
...
set(pkg_cfg_extras "ekf-msg-extras.cmake")
