...
(cl:defmethod cl:initialize-instance :after ((m <pos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ekf-msg:<pos> is deprecated: use ekf-msg:pos instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ekf-msg:x-val is deprecated.  Use ekf-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ekf-msg:y-val is deprecated.  Use ekf-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'psi-val :lambda-list '(m))
(cl:defmethod psi-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ekf-msg:psi-val is deprecated.  Use ekf-msg:psi instead.")
  (psi m))

(cl:ensure-generic-function 'dx-val :lambda-list '(m))
(cl:defmethod dx-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ekf-msg:dx-val is deprecated.  Use ekf-msg:dx instead.")
  (dx m))

(cl:ensure-generic-function 'dpsi-val :lambda-list '(m))
(cl:defmethod dpsi-val ((m <pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ekf-msg:dpsi-val is deprecated.  Use ekf-msg:dpsi instead.")
  (dpsi m))
