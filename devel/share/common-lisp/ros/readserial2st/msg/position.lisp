...
(cl:defmethod cl:initialize-instance :after ((m <position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name readserial2st-msg:<position> is deprecated: use readserial2st-msg:position instead.")))

(cl:ensure-generic-function 'positionX-val :lambda-list '(m))
(cl:defmethod positionX-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader readserial2st-msg:positionX-val is deprecated.  Use readserial2st-msg:positionX instead.")
  (positionX m))

(cl:ensure-generic-function 'positionY-val :lambda-list '(m))
(cl:defmethod positionY-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader readserial2st-msg:positionY-val is deprecated.  Use readserial2st-msg:positionY instead.")
  (positionY m))
