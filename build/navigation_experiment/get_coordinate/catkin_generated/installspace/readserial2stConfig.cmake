...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'readserial2st' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chenlee/robot_navigation/install/${idir}'.  Ask the maintainer 'chenlee <chenlee@todo.todo>' to fix it.")
    endif()
